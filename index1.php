...
//use myapplication;
//create table users(Id int, username varchar(25), password varchar(30), email varchar (30), phonenumber int);
//
<?php
session_start();
...
try {
    $conn = new PDO("mysql:host=$servername;dbname=myapplication", $username, $password);
